...
<form class="woocommerce-EditAccountForm edit-account" action=""
    ...
    <p>
        ...
        <button type="submit"
                class="woocommerce-Button button alt btn btn-primary py-2 px-4 mb-3<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
